    ...
    async function loadCategories(){
        ...
        try{
            ...
            categories.forEach((cat)=>{
                ...
                //Funcionabilidad para botones de Editar
                ...
                tableBody.appendChild(tr); //Al TBODY se le concatena la nueva vila creada 
            });        
        }
        catch(err){
            console.error("error cargando caterogias:", err);
        }
    }
    function init(){
        loadCategories();
